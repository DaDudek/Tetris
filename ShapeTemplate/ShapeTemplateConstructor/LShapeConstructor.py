...
def construct():
    first_rotate = Box([Row([Field(False), Field(False), Field(False), Field(True)]),
                        Row([Field(True),  Field(True),  Field(True),  Field(True)]),
                        Row([Field(False), Field(False), Field(False), Field(False)]),
                        Row([Field(False), Field(False), Field(False), Field(False)])
                        ])

    second_rotate = Box([Row([Field(False), Field(True), Field(False), Field(False)]),
    ...
    third_rotate = Box([Row([Field(False), Field(False), Field(False), Field(False)]),
                        Row([Field(False), Field(False), Field(False), Field(False)]),
                        Row([Field(True),  Field(True),  Field(True),  Field(True)]),
                        Row([Field(True),  Field(False), Field(False), Field(False)])
                        ])

    fourth_rotate = Box([Row([Field(True),  Field(True), Field(False), Field(False)]),
                         Row([Field(False), Field(True), Field(False), Field(False)]),
                         Row([Field(False), Field(True), Field(False), Field(False)]),
                         Row([Field(False), Field(True), Field(False), Field(False)])
                         ])
